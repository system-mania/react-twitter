...
export default function HomePage() {
  ...
  const [followingPosts, setFollowingPosts] = useState<PostProps[]>([]); // ['all', 'following'
  const [followingIds, setFollowingIds] = useState<string[]>(['']); // ['all', 'following'
  const [activeTab, setActiveTab] = useState<tabType>('all'); // ['all', 'following'
